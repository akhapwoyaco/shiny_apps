...
```{r, include=FALSE}
knitr::opts_chunk$set(echo = F, out.height = "\\textheight",  out.width = "\\textwidth")
```
...
```{r,warning=FALSE,message=FALSE,attr.source='.numberLines',attr.output='.numberLines', fig.align='center', dpi = 450, fig.width=10, fig.height=9, fig.cap='Correlation Plot All Data'} 
# Correlation
...
```{r,warning=FALSE,message=FALSE,attr.source='.numberLines',attr.output='.numberLines', fig.align='center', dpi = 450, fig.width=10, fig.height=9, fig.cap='Correlation Plot Location'} 
# Correlation
...
```{r,warning=FALSE,message=FALSE,attr.source='.numberLines',attr.output='.numberLines', fig.align='center', dpi = 450, fig.width=10, fig.height=9, fig.cap='Temperature Plot Location'} 
...
```{r,warning=FALSE,message=FALSE,attr.source='.numberLines',attr.output='.numberLines', fig.align='center', dpi = 450, fig.width=10, fig.height=9, fig.cap='Humidity Plot Location'} 
...
```{r,warning=FALSE,message=FALSE,attr.source='.numberLines',attr.output='.numberLines', fig.align='center', dpi = 450, fig.width=10, fig.height=9, fig.cap='Maximum Wind Speed Plot Location'} 
...
### Time of Maximum Wind Gust: Which time of day and weekday do we experience maximum wind gust

```{r,warning=FALSE,message=FALSE,attr.source='.numberLines',attr.output='.numberLines', fig.align='center', dpi = 450, fig.width=10, fig.height=8, fig.cap='Maximum Wind Gust Frequency'}
wind_maxtime_plot()
```

### Direction of Maximum Wind Gust: Which month and direction does the Wind Gust move to (Excludes Missing Directions)

```{r}
# australian_wind_direction() |> 
#   pivot_wider(
#     names_from = direction_of_maximum_wind_gust, values_from = n) |>
#   knitr::kable(caption = "Frequency of wind direction")
```

```{r,warning=FALSE,message=FALSE,attr.source='.numberLines',attr.output='.numberLines', fig.align='center', dpi = 450, fig.width=10, fig.height=8, fig.cap='Maximum Wind Gust Direction Frequency'}
wind_direction_plot()
```
...
```{r,warning=FALSE,message=FALSE,attr.source='.numberLines',attr.output='.numberLines', fig.align='center', dpi = 450, fig.width=10, fig.height=8, fig.cap='Pressure: 9am and 3pm'}
